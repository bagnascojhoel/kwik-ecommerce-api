...
public class RestExceptionHandler implements RestExceptionHandlerApi {
  ...
  public ErrorDto handleResourceNotFound(final HttpServletRequest httpServletRequest,
      final AbstractResourceNotFoundException abstractResourceNotFoundException) {
    return ErrorDto.builder()
        .typeUri(
            "/errors/client-errors/not-founds/" + abstractResourceNotFoundException.getErrorCode())
        .title(Objects.requireNonNullElse(abstractResourceNotFoundException.getMessage(),
            "Resource not found"))
        .build();
  }
  ...
  public ErrorDto handleBadRequest(
    ...
    return switch (anException.getClass().getSimpleName()) {
      case "InvalidValueException" ->
          handleInvalidValue(httpServletRequest, (InvalidValueException) anException);
      case "MethodArgumentNotValidException" -> handleMethodArgumentNotValid(httpServletRequest,
      ...
      case "HttpMessageNotReadableException" -> handleHttpMessageNotReadable(httpServletRequest,
          (HttpMessageNotReadableException) anException);
      default -> throw new UnsupportedOperationException("unable to handle exception", anException);
    };
  }
  ...
  public ErrorDto handleInternalServerError(
    ...
    var message = "internal server error, endpoint={}".replace("{}",
  ...
  private ErrorDto handleInvalidValue(final HttpServletRequest httpServletRequest,
      final InvalidValueException invalidValueException) {
    return ErrorDto.builder()
